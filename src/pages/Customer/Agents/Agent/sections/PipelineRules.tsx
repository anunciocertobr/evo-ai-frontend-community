  ...
  return (
    <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        <SelectTrigger className="w-full rounded-[9px] border-[#E3E6EA] bg-white">
                          <SelectValue
                            placeholder={
                    ...
                    <Button
                      ...
                      className="h-auto flex-shrink-0 rounded-[9px] border-[#E3E6EA] bg-white p-[9px]"
                    >
                    ...
                    <div className="space-y-2">
                      <div className="space-y-1.5">
                        <div className="flex items-center gap-2">
                          ...
                          <Label
                            ...
                            className="cursor-pointer text-[13.5px] text-[#1A211E]"
                          >
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <span className="flex-shrink-0 text-xs text-[#9AA3A0]">
                        ...
                        <Textarea
                          ...
                          maxLength={500}
                          className="min-h-[90px] rounded-[9px] border-[#E3E6EA] bg-white text-sm placeholder:text-[#AEB6BC]"
                        />
                      </div>
                    </div>
                  )}
                  ...
                  {rule.pipelineId && selectedPipeline && (
                    <div className="space-y-2">
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            ...
                            <Textarea
                              ...
                              maxLength={255}
                              className="min-h-[70px] rounded-[9px] border-[#E3E6EA] bg-white text-sm placeholder:text-[#AEB6BC]"
                            />
                          </div>
                        </div>
                      ))}
                      ...
                      <Button
                        ...
                        className="h-auto w-full rounded-[10px] border-[#ECEEF2] bg-white py-[10px] text-[13px] font-semibold text-[#1A211E]"
                      >
      ...
      <Button
        ...
        className="h-auto w-full rounded-[12px] border-[#ECEEF2] bg-white py-[14px] text-sm font-semibold text-[#1A211E]"
      >
        <Plus className="mr-2 h-4 w-4" />
