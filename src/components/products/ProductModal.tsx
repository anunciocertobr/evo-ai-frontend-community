      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto flex flex-col">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 overflow-hidden flex flex-col">
          {/*
            ...
            "media" (drag-drop image upload, validated against
            ACCEPTED_IMAGE_TYPES/MAX_IMAGE_BYTES) and "gallery" (upload OR pick
            an existing image/video by URL, see openGallery/handleMediaFiles)
            are two distinct features that both happened to be built as a
            "media" tab — kept as separate tabs with separate value/ref
          ...
          */}
          ...
          <TabsContent value="gallery" className="space-y-4 overflow-y-auto pt-4">
            <div className="flex flex-wrap gap-2">
              <input
